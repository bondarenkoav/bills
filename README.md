# bills
 ...
 Система написана штатным программистом под нужды компании в которой работает (ЧОП). При желании получить приложение и возможно самого программиста в штат - пишите. Я готов к обсуждению цены и смены города и места работы.
